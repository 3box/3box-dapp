...
const MyProfileHeaders = ({
  ...
  currentAddress,
    ...
    <Helmet>
      ...
      <meta property="og:image" content={`${(image && image[0]) ? `https://ipfs.infura.io/ipfs/${image[0].contentUrl['/']}` : 'https://i.imgur.com/RXJO8FD.png'}`} />
      ...
      <meta property="twitter:image" content={`${(image && image[0]) ? `https://ipfs.infura.io/ipfs/${image[0].contentUrl['/']}` : 'https://i.imgur.com/RXJO8FD.png'}`} />
    </Helmet>
  );
