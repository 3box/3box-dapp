    ...
    <div className="info__page">
      ...
      <div className="info__content">
        <div className="info__content__text">
          <h3>
            THIS IS THE ALPHA VERSION OF THE 3BOX PLATFORM
            WHICH IS STILL UNDERGOING TESTING BEFORE ITS
            OFFICIAL RELEASE. THE INFORMATION AVAILABLE IS
            NOT INTENDED TO BE RELIED ON OR USED IN A PRODUCTION
            ENVIRONMENT. YOU ACKNOWLEDGE AND ACCEPT THAT THE SITE
            AND SERVICES (A) MAY CONTAIN BUGS, ERRORS, AND DEFECTS,
            (B) MAY FUNCTION IMPROPERLY OR BE SUBJECT TO PERIODS OF
            DOWNTIME AND UNAVAILABILITY, (C) MAY RESULT IN TOTAL OR
            PARTIAL LOSS OR CORRUPTION OF DATA USED IN THE SITE AND
            SERVICES, AND (D) MAY BE MODIFIED AT ANY TIME, INCLUDING
            THROUGH THE RELEASE OF SUBSEQUENT VERSIONS, ALL WITH OR
            WITHOUT NOTICE. THE ALPHA PLATFORM IS AVAILABLE ON AN
            “AS IS” AND “AS AVAILABLE” BASIS FOR THE SOLE PURPOSE
            OF COLLECTING FEEDBACK ON QUALITY, USABILITY, PERFORMANCE
            AND ANY DEFECTS. THANK YOU FOR YOUR SUPPORT WHILE WE CONTINUE
          ...
          wave of highly usable dapps. These terms of use (“Terms” or “Terms of Use”) govern
          your use of the website located at https://3box.io (the “Site”), platform, and all
          related tools, applications, data, software, and other services provided by us (the
          “Service”). Certain features of the Site and Services may be subject to additional
          ...
          by reference into these Terms and constitute a legally binding agreement between
          you and Company in relation to your use of the Service. Any personal information
          submitted in connection with your use of the Service is subject to our Privacy
          Policy, which is hereby incorporated by reference into these Terms.
          THESE TERMS SET FORTH THE LEGALLY BINDING TERMS AND CONDITIONS THAT GOVERN YOUR
          USE OF THE SITE AND SERVICES.  BY ACCESSING OR USING THE SITE OR SERVICES, YOU
          ARE ACCEPTING THESE TERMS (ON BEHALF OF YOURSELF OR THE ENTITY THAT YOU REPRESENT),
          ...
          YOU FURTHER REPRESENT AND WARRANT THAT YOU ARE OTHERWISE LEGALLY PERMITTED TO USE
          THE SERVICES IN YOUR JURISDICTION AND THAT THE COMPANY IS NOT LIABLE FOR YOUR
          COMPLIANCE WITH SUCH APPLICABLE LAWS. YOU MAY NOT ACCESS OR USE THE SITES OR
          SERVICES OR ACCEPT THE TERMS IF YOU ARE NOT AT LEAST 18 YEARS OLD.  YOU FURTHER
          REPRESENT AND WARRANT THAT YOU UNDERSTAND AND ARE WILLING TO ACCEPT THE RISKS
          ASSOCIATED WITH CRYPTOGRAPHIC SYSTEMS SUCH AS THE INTERPLANETARY FILE SYSTEM. IF
          YOU DO NOT AGREE WITH ALL OF THE PROVISIONS OF THESE TERMS, DO NOT ACCESS AND/OR
          USE THE SITE AND SERVICES.
          THESE TERMS REQUIRE THE USE OF ARBITRATION (SECTION 13.2) ON AN INDIVIDUAL BASIS
          TO RESOLVE DISPUTES, RATHER THAN JURY TRIALS OR CLASS ACTIONS, AND ALSO LIMIT THE
          ...
          <p>
            ...
            files, content, messages, and so on (“User Content”).You may choose to share User
            Content publicly, in which case it will be accessible and viewable by anybody. You
            may also choose to authorize selected decentralized applications to interact with
            your private profile by approving the following message: “This app wants to view
            and update your profile.” Each party that you provide such private access to will
            be able to view and make changes to the same data. Such parties will be able to store
            additional data and/or delete data in your private profile. You should not use 3Box to
            store sensitive personal data which you don’t want accessible to others.  If you shared
            User Content which you no longer want to share publicly or privately using our
            Services,
            you must either delete that User Content or your Account. By making such deletion, the
            relevant User Content will become unlinked from the IPFS network and will be deleted
            from our IPFS node. You agree to immediately notify Company of any unauthorized use, or
          ...
          <p>
            ...
            any content displayed on the Site or Services; (b) you shall not modify, make
            derivative works of, disassemble, reverse compile or reverse engineer any part of the
            Site or Services; (c) you shall not access the Site or Services in order to build a
            similar or competitive website, product, or service; (d) except as expressly stated
            herein, no part of the Site or Services may be copied, reproduced, distributed,
            republished, downloaded, displayed, posted or transmitted in any form or by any means,
            (e) you shall not use the Site or Services to store or transmit computer viruses,
            works, time bombs, Trojan horses and other harmful or malicious code, routines, files,
            scripts, agents or programs; (f) you shall not use the Site or Services to store or
            distribute any information, material or data that is harassing, threatening,
            infringing,
            libelous, unlawful, obscene, or which violates the privacy or intellectual property
            rights of any third party; and (g) you shall not interfere with or disrupt the
            integrity
            or performance of the Site or Services or third-party data contained therein.
            ...
            suppliers.
            Neither these Terms (nor your access to the Site) transfers to you or any third party
            any
          ...
          <p>
            ...
            third
            party.  You hereby represent and warrant that your User Content does not violate our
            Acceptable Use Policy (defined in Section ‎3.3).  You may not represent or imply to
            others
            ...
            to backup or maintain any User Content, and your User Content may be deleted at any
            time
            ...
            reproduce,
            distribute, publicly display and perform, prepare derivative works of, incorporate into
            other
            works, and otherwise use and exploit your User Content, and to grant sublicenses of the
            foregoing rights, solely for the purposes of including your User Content in the Site
            and
            ...
            us or any other
            person. Such action may include no longer maintaining some or all of your User
            Content, limiting or
            ...
            it helps us develop
            the platform and offer the best Service possible. If you provide Company with
            any feedback or
            suggestions regarding the Site or Service (“Feedback”), you hereby assign to
            Company all rights in
            such Feedback and agree that Company shall have the right to use and fully act
            on such Feedback and
            related information in any manner it deems appropriate.  Company will treat any
          ...
          <p>
            ...
            & Ads are not under
            the control of Company, and Company is not responsible for any Third-Party Links
            & Ads.  Company
            provides access to these Third-Party Links & Ads only as a convenience to you,
            and does not review,
            ...
            any User Content,
            whether provided by you or by others, such as dapps which you’ve private access
            to.  We make no
            ...
            has arisen or arises directly or indirectly out of, or that relates directly
            ...
            IN CONNECTION WITH THE FOREGOING, WHICH STATES: “A GENERAL RELEASE DOES NOT
          ...
          <h3>6. DISCLAIMERS</h3>
          <p>
            THE SITE AND SERVICES  EXPRESSLY DISCLAIM ANY AND ALL WARRANTIES AND CONDITIONS
            OF ANY KIND,
            ...
            NON-INFRINGEMENT.  WE (AND
            OUR SUPPLIERS) MAKE NO WARRANTY THAT THE SITE OR SERVICES WILL MEET YOUR
            REQUIREMENTS, WILL BE
            AVAILABLE ON AN UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE BASIS, OR WILL
            BE ACCURATE, RELIABLE,
            FREE OF VIRUSES OR OTHER HARMFUL CODE, COMPLETE, LEGAL, OR SAFE.  IF APPLICABLE
            LAW REQUIRES ANY
            WARRANTIES WITH RESPECT TO THE SITE OR SERVICES, ALL SUCH WARRANTIES ARE LIMITED
            IN DURATION TO
          ...
          <p>
            ...
            RELATING TO THESE TERMS OR YOUR USE OF, OR INABILITY TO USE, THE SITE OR
            SERVICES, EVEN IF COMPANY
            HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.  ACCESS TO, AND USE
            OF, THE SITE OR SERVICES
            IS AT YOUR OWN DISCRETION AND RISK, AND YOU WILL BE SOLELY RESPONSIBLE FOR
            ANY DAMAGE TO YOUR DEVICE
            OR COMPUTER SYSTEM, OR LOSS OF DATA RESULTING THEREFROM.
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, NOTWITHSTANDING ANYTHING TO THE
            CONTRARY CONTAINED HEREIN,
            OUR LIABILITY TO YOU FOR ANY DAMAGES ARISING FROM OR RELATED TO THIS
          ...
          <p>
            ...
            present risks to cryptographic
            systems and the Services, which could result in the theft or loss of
            your property. To the extent
            possible, the Company intends to update the code underlying the Services
            to account for any advances
            in cryptography and to incorporate additional security measures, but does
          ...
          <p>
            ...
            You further expressly acknowledge and represent that applications can be
            written maliciously or negligently,
            that we cannot be held liable for your interaction with such third party
            applications. These warnings and
          ...
          discretion, including for any use of the Site or Services in violation of
          these Terms.  Upon termination of your rights under these Terms, your Account
          and right to access and use the Site and Services will terminate immediately.
          ...
          these Terms, including for termination of your Account or deletion of your User
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                ...
                a written Notice of Dispute (“Notice”) describing the nature and basis of
                the claim or dispute, and the requested relief.  A Notice to the Company
                should be sent to: 49 Bogart St. #22, Brooklyn, New York 11206.  After
              ...
              <li>
                ...
                a hearing will be determined by the Arbitration Rules.  Any judgment on the
              ...
              <li>
                ...
                limited, more efficient and less costly than rules applicable in a court and
              ...
              <li>
                ...
                but not limited to the award of the arbitrator and compliance therewith,
            ...
            these Terms will be unimpaired and the invalid or unenforceable provision
