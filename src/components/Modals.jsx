...
export const SwitchedNetworksModal = ({ prevNetwork, currentNetwork, handleSwitchedNetworkModal, show }) => (
  <div>
    <div className={`${show ? "showModal" : ""} modal__container modal--effect`}>
      <div className="modal">
        ...
        <div>
          ...
          <p>Your profile will stay the same, but your Ethereum activity will update</p>
          <p id="modal__switchBack">
            <b>{`Switch back to ${prevNetwork} in MetaMask or continue on ${currentNetwork}`}</b>
          </p>
        </div>
...
export const SwitchedAddressModal = ({ handleSwitchedAddressModal, show, handleSignOut, isMobile, prevAddress }) => (
  <div>
    <div className={`${show ? "showModal" : ""} modal__container modal--effect`}>
      <div className="modal">
        <img src={Switched} alt="Partners background" id="modal__switchedNetworks" />
  ...
  <div>
    <div className={`${show ? "showModal" : ""} modal__container modal--effect`}>
      <div className="modal">
        ...
        <button onClick={handleConsentModal} type="button" className="tertiaryButton">
          Close
        </button>
      </div>
    </div>
    ...
    <div className={`${show ? "showModal" : ""} modal__container modal--effect`}>
      <div className="modal">
        ...
        <div id="modal__copy__card">
          ...
          {isMobile ? (
            <p>
              This allows 3Box to read the addresses associated with your account. Please make sure you are logged in to
              your web3 wallet
            </p>
          ) : (
            <p>
        ...
        {!directLogin && (
          <button onClick={handleAccessModal} type="button" className="tertiaryButton">
            Close
          </button>
        )}
      </div>
  ...
  <div>
    <div className={`${show ? "showModal" : ""} modal__container modal--effect`}>
      <div className="modal">
        ...
        <button onClick={handleDeniedAccessModal} type="button" className="tertiaryButton">
          Close
        </button>
      </div>
    </div>
  ...
  <div>
    <div className={`${show ? "showModal" : ""} modal__container modal--effect`}>
      <div className="modal">
        ...
        <button onClick={closeFileSizeModal} type="button" className="tertiaryButton">
          Close
        </button>
      </div>
    </div>
  ...
  <div className="mobileInvisible">
    <div className={`${show ? "showModal" : ""} modal__container modal--effect`}>
      <div className="modal">
        ...
        <div id="modal__copy__card">
          <h3>Install Web3 Wallet</h3>
          {isMobile ? <p>You must have a web3 wallet to use 3Box</p> : <p>You must have MetaMask to use 3Box</p>}
        </div>

        <button onClick={closeRequireMetaMaskModal} type="button" className="tertiaryButton">
          Close
        </button>
      </div>
    </div>
    ...
    <div className={`${show ? "showModal" : ""} modal__container modal--effect`}>
      <div className="modal">
        ...
        <div id="modal__copy__card">
          ...
          {isMobile ? <p>Unlock your web3 wallet to continue</p> : <p>Unlock your MetaMask wallet to continue</p>}
        </div>
        <button onClick={handleRequireWalletLoginModal} type="button" className="tertiaryButton">
          Close
        </button>
      </div>
    </div>
    ...
    <div className={`${show ? "showModal" : ""} modal__container modal--effect`}>
      <div className="modal">
          ...
          id={
            (errorMessage &&
              errorMessage.message.substring(0, 65) ===
                "Error: MetaMask Message Signature: User denied message signature.") ||
            (errorMessage &&
              errorMessage.message.substring(0, 58) === "Error: MetaMask Message Signature: from field is required.") ||
            (errorMessage && errorMessage.message.substring(0, 26) === "value/</<@moz-extension://")
              ? "modal__copy__card"
              : ""
          }
        >
          ...
          (errorMessage && errorMessage.message.substring(0, 26) === "value/</<@moz-extension://") ? (
            <p>
              You must provide consent to 3Box in your web3 wallet (e.g. MetaMask) to sign in or create a profile,
              please try again
            </p>
          ) : (
        ...
        <button onClick={closeErrorModal} type="button" className="tertiaryButton">
          Close
        </button>
      </div>
    </div>
  ...
  <div>
    <div className={`${show ? "showModal" : ""} modal__container modal--effect`}>
      <div className="modal">
        ...
        <button onClick={handleSignInModal} type="button" className="tertiaryButton">
          Close
        </button>
      </div>
    </div>
...
export const MobileWalletRequiredModal = ({ isIOS, handleMobileWalletModal, show }) => (
  <div id="mobile__landing__prompt" className={`${show ? "showMobileModal" : "hideMobileModal"}`}>
    ...
    <button
      onClick={() => handleMobileWalletModal()}
      type="button"
      className="tertiaryButton mobile__landing__closeButton"
    >
      X
    </button>
  </div>
...
export const OnBoardingModalDesktop = ({ handleOnboardingModal, showOne, showTwo, isMobile }) => (
  <div>
    <div
      className={`${
        (showOne || showTwo) && !isMobile ? "showModal" : ""
      } modal__onBoardingModal__container modal--effect`}
    >
      <div className={`${showOne ? "showModalImage" : ""} modal__onBoardingModal`}>
        ...
        <button onClick={() => handleOnboardingModal(false)} type="button" id="modal__onBoardingModal__button">
          Get started
        </button>
      ...
      <div className={`${showTwo ? "showModalImage" : ""} modal__onBoardingModal`}>
        ...
        <button onClick={handleOnboardingModal} type="button" id="modal__onBoardingModal__button">
          Let's go
        </button>
        <div id="modal__onBoardingModal__progressBar">
          <div id="modal__onBoardingModal__progressBar__progress--dull" />
...
export const OnBoardingModalMobile = ({
  ...
  <div>
    <div
      className={`${
        (showOne || showTwo || showThree || showFour) && isMobile ? "showModal" : ""
      } modal__onBoardingModal__container modal--effect`}
    >
      <div className={`${showOne ? "showModalImage" : ""} modal__onBoardingModal`}>
        <img
          src={OnBoardingModalGraphic}
          alt="Partners background"
          className={`${showOne ? "fadeImage" : ""} modal__onBoardingModal__image`}
        />
        <button
          onClick={() => {
            handleNextMobileModal(undefined, "One");
            handleOnboardingModal(isMobile);
          }}
          type="button"
          id="modal__onBoardingModal__button"
        >
          Get started
        </button>
        <div id="modal__onBoardingModal__progressBar">
      ...
      <div className={`${showTwo ? "showModalImage" : ""} modal__onBoardingModal`}>
        <img
          src={OnBoardingModalMobileGraphic1}
          alt="Partners background"
          className={`${showTwo ? "fadeImage" : ""} modal__onBoardingModal__image`}
        />
        <button onClick={() => handleNextMobileModal("One", "Two")} type="button" id="modal__onBoardingModal__button">
          Next
        </button>
        <div id="modal__onBoardingModal__progressBar">
          <div id="modal__onBoardingModal__progressBar__progress--dull" />
      ...
      <div className={`${showThree ? "showModalImage" : ""} modal__onBoardingModal`}>
        <img
          src={OnBoardingModalMobileGraphic2}
          alt="Partners background"
          className={`${showThree ? "fadeImage" : ""} modal__onBoardingModal__image`}
        />
        <button onClick={() => handleNextMobileModal("Two", "Three")} type="button" id="modal__onBoardingModal__button">
          Next
        </button>
        <div id="modal__onBoardingModal__progressBar">
          <div id="modal__onBoardingModal__progressBar__progress--dull" />
      ...
      <div className={`${showFour ? "showModalImage" : ""} modal__onBoardingModal`}>
        <img
          src={OnBoardingModalMobileGraphic3}
          alt="Partners background"
          className={`${showFour ? "fadeImage" : ""} modal__onBoardingModal__image`}
        />
        <button
          onClick={() => handleNextMobileModal("Three", undefined)}
          type="button"
          id="modal__onBoardingModal__button"
        >
          Let's go
